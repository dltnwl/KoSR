...
REGISTER_OP("CTCJamoSearchDecoder")
    .Input("inputs: float")
...
// CTC beam search
class CTCJamoSearchDecoderOp : public OpKernel {
 public:
  explicit CTCJamoSearchDecoderOp(OpKernelConstruction* ctx) : OpKernel(ctx) {
  ...
  void Compute(OpKernelContext* ctx) override {
    ...
    ctc::CTCBeamSearchDecoder<JamoState> beam_search(num_classes, beam_width_,
 ...
 private:
  ...
  JamoScorer beam_scorer_;
  bool merge_repeated_;
  int beam_width_;
  TF_DISALLOW_COPY_AND_ASSIGN(CTCJamoSearchDecoderOp);
};

REGISTER_KERNEL_BUILDER(Name("CTCJamoSearchDecoder").Device(DEVICE_CPU),
                        CTCJamoSearchDecoderOp);
